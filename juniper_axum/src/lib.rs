...
use coasys_juniper_graphql_ws::Schema;
...
pub fn graphiql<'a>(
    ...
    let html = Html(coasys_juniper::http::graphiql::graphiql_source(
...
pub fn playground<'a>(
    ...
    let html = Html(coasys_juniper::http::playground::playground_source(
        graphql_endpoint_url,
        subscriptions_endpoint_url.into(),
    ));
